...
def settings():
    ...
    while intro:
        ...
        text.button("Music ON",350,150,100,50,globals.grey,globals.bright_red,lambda: music("start"))
        text.button("Music OFF",350,200,100,50,globals.grey,globals.bright_red,lambda: music("stop"))
