...
def show():
    ...
    while credits:
        ...
        text.button("Fabian !",95,475,100,50,globals.purple,globals.bright_grey,None)
        text.button("Tim !",275,475,75,50,globals.green2,globals.bright_grey,None)
        text.button("Bob !",440,475,75,50,globals.red2,globals.bright_grey,None)
        text.button("Damian !",605,475,100,50,globals.blue2,globals.bright_grey,None)
